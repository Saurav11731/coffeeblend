		...
		<section class="ftco-section ftco-cart">
			<div class="container">
    			...
    			<div class="col-md-12 ftco-animate">
    				<div class="cart-list">
	    				<table class="table table-dark" style=" width:1100px" >   
						    ...
						    <tbody>
						      ...
						      <tr class="text-center" style="height: 140px;">
                                ...
                                @endforeach
                                @else
                                <p class="alert alert-success">You have no products in the cart</p>
                                @endif
						    </tbody>
						  </table>
					  </div>
    		...
    		<div class="row justify-content-end">
    			<div class="col col-lg-3 col-md-6 mt-5 cart-wrap ftco-animate">
                    ...
                    @else
                    <p class="text-center alert alert-success">you can't checkout because you have no item in the cart</p>
                    @endif
    			</div>
    		</div>
			</div>
